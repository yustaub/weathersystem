...
public class WeatherActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //请求新选择的城市的天气信息
        ...
        if (bingPic != null) {
            ...
            Glide.with(this).load(bingPic).into(bingPicImg);//加载每日一图
        } else {
    ...
    public void requestWeather(final String weatherId) {
        //组装接口地址
        String weatherUrl = "http://guolin.tech/api/weather?cityid=" + weatherId + "&key=78ba59813bdb47fd946bde646c49d80d";
    ...
    private void loadBingPic() {
        String requestBingPic = "http://guolin.tech/api/bing_pic";   //服务器返回今日的必应背景图链接
